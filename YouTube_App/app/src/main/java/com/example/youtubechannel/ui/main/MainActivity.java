...
public class MainActivity extends BaseMVPDialogActivity implements MainMVPView {
    ...
    public void onErrorCallApi(int code) {
        GlobalFuntion.showMessageError(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_see_all_playlist:
                GlobalFuntion.startActivity(this, PlaylistActivity.class);
                break;

            case R.id.layout_my_channel:
                GlobalFuntion.startActivity(this, MyChannelActivity.class);
                break;
            ...
            case R.id.layout_about:
                GlobalFuntion.startActivity(this, AboutUsActivity.class);
                break;
        }
        mDrawerLayout.closeDrawer(GravityCompat.START);
    }
    ...
    private void goToAllVideoActivity(String type) {
        ...
        GlobalFuntion.startActivity(this, AllVideoActivity.class, bundle);
    }
